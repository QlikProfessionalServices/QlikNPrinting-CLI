<#
.SYNOPSIS
	Exports an NPrinting app's report templates.
.DESCRIPTION
	POST /apps/{id}/actions/export-templates. Returns the action result (typically
	a location/handle for the exported package).
.PARAMETER Id
	The id of the app whose templates to export.
.EXAMPLE
	Export-NPAppTemplates -Id $appId
#>
function Export-NPAppTemplates {
	...
	process {
		if ($PSCmdlet.ShouldProcess("app $Id", 'Export templates')) {
			Invoke-NPRequest -Method Post -Path "apps/$Id/actions/export-templates"
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAF8bAjlzD4wLSY
# GW2PkIZrvYI7jdhEiA6DpkvVi1brDKCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAmrFrY
# YUlKAdhuWKk9P4rL9tEfLhmbwuX2xXiDaBGXZDAKBggqhkjOPQQDAgRnMGUCMBgq
# mommkC3WiPW+0FXanl4bNjcDXcwvyGoRF9FTWCoON2cBd0c1xVINXfYA5H2trAIx
# AO7rVU/BfxjGtewfkC59RG1iDAVVqd0kYHTajGwH+zTAr+kJrkZovufAW1axlEVM
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDU1NVowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMG/aVGa5
# bpMGhwfOO60FF5/JIoC+HxowmhpArtFVPZwQtd9uj74h4tNy5ELiTVBWIzCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYAn68VesWWs
# ihYne8fWjiWVF/5N8nGad/BFgN9t+HOB1YA3WGGp01yTuAD0wF/86dbobLEM08zW
# PVcnwrFFyDMBFRZ8Iz9Mw8HIHN8NWDkxOHJv5A+ShfHvmhpRswGPJAkuTkUZgkyo
# wqZnRKM50tH6Ortz2wsHVyNUmquSvlzRg4qtu6ttSX1TUrKMGUShrDrNhOQhhgWP
# bIusI5a/hl81taslUIJ5R8FhrdynkOn/RnH776a/7JLWPMc/UASvQM1b6YUhfDi4
# Rmvl3AKZ+aguQaY+mlhmxpkoivK0ZQrI+GZjrhvD5ZuwKSmAdgq/YmAlYEEKcJ4v
# zXnh6uQYLvYXAfQKH+iiEX8QwXBSo00YM+0PcQNmq22jDE29eQayhEJvK3fLV92G
# 1C+oHI+YJRpD2ma8s7CjrL8AKyBfjb2FpNPanIgsmXS/OnG/byS5zOEEG9NOYaw5
# p3ouEQA9yxFiz57vHI5GrBb4+pxgDcLSi5Zbr8pw3M2h/1SbqLS+4ig=
