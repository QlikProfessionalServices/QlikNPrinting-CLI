<#
.SYNOPSIS
	Gets NPrinting audit logs.
.DESCRIPTION
	GET /audit/logs.
.EXAMPLE
	Get-NPAuditLogs
#>
function Get-NPAuditLogs {
	[CmdletBinding()]
	param()

	Invoke-NPRequest -Method Get -Path 'audit/logs'
}

# SIG # Begin signature block
# MIIfdQYJKoZIhvcNAQcCoIIfZjCCH2ICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKx5ZowbsslxZ3
# LFie/TaaLlGLQSG4MlJeTTsnAW0ymqCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBhqunK
# UiyNiEaXzCS34lwraAjRC5DJe32rk5Mv9jOhFDAKBggqhkjOPQQDAgRnMGUCMQDv
# DB/SJREFH6RpUOi4JvUeD7H0RDQMHO2x6lG4y1CidebXEj+EEu/of+lPLO23s64C
# MGnlS7mpDGZK06JR5RUYHQIaFpbpOpslkB4ABoLT5/ik2PTeV+vhSCsHV+Nv1iHg
# GqGCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDU1OVowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMFo/Mjc1
# ItPRt27P+LxtFv/78o/4DluUsrOtKsV+/4KqI2hqpuIDcdLOTcwwB7uRDzCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYAmoetRSNf5
# A5/0mJCboGsHcJjatKzgv54MpirpfHQG8vJb+jiB+9mRhPWuG7KkJm4uI5cQ7soS
# W0HnNx4aIPO2hXgHnwsQhph6dxJaXR7XhaozMAn/YZgJkY6j4s8Qx6D8V6+XxLaA
# hxwqn9fs35Uj+J/YbJKSjj1qoOvtCtMrt+k4sY2SMDSc/TX6lIkx0yzljkBwrnvc
# q57iGqm36ZDCY3DAyKO1FtnMCYrKKVpHxGzSmkrdjyGyOBnXFezGGrt6OxmpbkjI
# 4Hk8u2GpJDPN6UskSUAouUBgSFDr2SLYSjGK5n3fjuZq+5SE0G4Dx22rJEDqEdCv
# /DqXbwg8Agv6LDYEnxO7mroikSJKKH7/c2hHHLXG8CEBen8Niwk6Lr54Nd4wo/nK
# rCvTZZREDqr0lOqZOmbnB60t1Lxbc+gJGfD7CRY+Ch2f2otMdfNxrULK/4fH8CPr
# NeWAayK86Rli4W2WdNUsVVecntm5SpTB+Lpe4msNoW1mh3dhimx441o=
