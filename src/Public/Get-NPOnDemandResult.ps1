<#
.SYNOPSIS
	Downloads the result of a completed on-demand report request.
.DESCRIPTION
	GET /ondemand/requests/{id}/result. Use -OutFile to save the generated report
	to disk.
.PARAMETER Id
	The id of the on-demand request. Accepts pipeline input by property name.
.PARAMETER OutFile
	Path to save the result to.
.EXAMPLE
	Get-NPOnDemandResult -Id $requestId -OutFile .\report.pdf
#>
function Get-NPOnDemandResult {
	[CmdletBinding()]
	param(
	...
	process {
		$params = @{
			Method = 'Get'
			Path   = "ondemand/requests/$Id/result"
		}
		if ($PSBoundParameters.ContainsKey('OutFile')) {
			$params.OutFile = $OutFile
		}
		Invoke-NPRequest @params
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBj520qAZIBwHAm
# 4tI1SfF8TI4hmdB+PBB8b4u9lDDPdaCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBEl8Wq
# CS+QroBhOYaBc0ytbglKQ2nZWhNuH4g+z27KHTAKBggqhkjOPQQDAgRoMGYCMQDm
# iU5EvxGHWInytjfP2QCaaFEjikX0tQZx6lk5PAOSVr7vsZonUmnmm2fVBkG6ExUC
# MQDZM63CZdqqwGlERZ060Cpd9Rb5KbLntr7zq74suWypbjetXCpPtVoVyFI/Dpgn
# zZWhggOEMIIDgAYJKoZIhvcNAQkGMYIDcTCCA20CAQEwczBeMQswCQYDVQQGEwJC
...
# MBwGCSqGSIb3DQEJBTEPFw0yNjA3MDExNDQ2MDRaMCsGCSqGSIb3DQEJNDEeMBww
# CwYJYIZIAWUDBAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDDkPii/
# 06YpVB6CtOL8vETpKg7frNrzwb+VIBqjaHK+kbRke2amIvsM29W3KD3VaA8wgagG
...
# MjAyNQIRAIRyP7gwDfuodbM7V8wmN4IwDQYJKoZIhvcNAQEMBQAEggGAEn7KLEl8
# pclKXlW4IxDZNPo/NtDkD7RMw2pp6In/Yd3okfdCFlr4nw34zUHZFiyNe0cjNiU8
# ANJyXOKdP5MmNrihAAlQpsGdjQQKEn3lzCYnIjKwAiE/hYNW2ZIQXOOCkozfJeLa
# uFD9AfX9c3dKUE6lmLxz79++LSmXanROC6i3pkJS4Ekv/UjKfRVufetsNNuG5HKh
# TEeMAWvjGa+yGk/XxO+cSdHy0sHaSPyFbAMiCUxwiY8v2kHbvifuNi4DpTWHylHX
# CxpN0sWvSShfquEMNYzRmRh2E+1yIhrc/7cK4xIa/iErFj/ZpRiS1jZbZyzk+Xny
# QYTraXjTIXGgNipjCpcqpzEdMHjBdZkWiyEnAvr9k5TGzBuurKeTs7y/03IwNhUL
# L8BmEvk2fb7JhfF5J6ovbfzHgVnz/UicpyNjWCpKI+RT5M/6pW8CVfYTgdFDAaE6
# UYg2iv6jfhP9LWlhRhaMkrMJt9++02SCGNdZEekOtB1zuHUkVsQ0/qRG
