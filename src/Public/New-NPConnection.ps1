<#
.SYNOPSIS
	Creates a new NPrinting connection.
.DESCRIPTION
	POST /connections. Pass the connection body as a hashtable or object. Returns
	the new connection's id and location.
.PARAMETER InputObject
	The connection body, e.g.
	@{ name = 'Sales'; appId = $appId; connectionType = 'local';
	   serverName = 'srv'; documentPath = 'C:\app.qvf' }.
.EXAMPLE
	New-NPConnection -InputObject $body
#>
function New-NPConnection {
	...
	process {
		if ($PSCmdlet.ShouldProcess("connection '$($InputObject.name)'", 'Create')) {
			Invoke-NPRequest -Method Post -Path 'connections' -Data $InputObject
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDaTH6b3eHKtMHE
# MxCkIJNe/+/Y5PEWHul8GJwJc3Q7JKCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBRJffc
# AhoAQ16/m7Tq+s2hIt+k/N9AuHKUnhuwWdSC3jAKBggqhkjOPQQDAgRnMGUCMFz2
# upauXUKALfRr91mOPR0wmJrbYyyqApwxaRoAC1QtvN6PIv+e3JEYzlPwJzID2wIx
# AOuFVuzFgjxsT3cBDlTbRmiNkguiu1YtayGXmBW07BctRXYBNQTTPPvtSEHCCspp
# maGCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDYxNFowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMG7J+Jbn
# hhAS3TJubdOLUUcE1dKiHxN57Hx0xcXkNysnlgcxXe+cjMy2wqimPzd01jCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYBEZ2d5zf67
# A2YABa7hK/HxaLa73BrrpyDBzjHslhs36YTHWXxMgsZWtKx+2egmW6o4c4IUDhsq
# 2YivGR4iJw/Rbg7kVpV17dLYlqipdSwPzWG5QTVYb5c+phBSAL1jLwa+0hkr9aRf
# R6W/grAOBe21XE6mj4IJCHySYxdqJ4rVNRmzQfOBg9Z6npiUD98RbRnU5omDrjTD
# yEHtccYe1M2ZBcZoK49fxZIq7M+pwilfOXm11IKr7FSp7KW26cx/kPH8A5G1vQ8o
# jSpfrYrT4J+306oACzcu80iwiitM/OSl9JVu2/9hn/YFa0q6CynuwXI9wsi5v3/m
# v6Bmld4TOxgFL3r5JYd9wPOShibiqFRUtU0+MQE7f88eh8Dz9swSak46qa7uqAOl
# 9xAnKes/mfjDenCWzfBpERmMRFQpZiOqwsJrMYy5yZqT8EqWYXru2TgyW/NTvZi+
# aL3fgUPETqZYKjy4OQWHeNzPwQmFPED57nxx/2di1eBRXkgkJBpPfu4=
