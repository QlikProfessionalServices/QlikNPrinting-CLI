<#
.SYNOPSIS
	Deletes an NPrinting user.
.DESCRIPTION
	DELETE /users/{id}. Supports -WhatIf/-Confirm.
.PARAMETER Id
	The id of the user to delete. Accepts pipeline input by property name.
.EXAMPLE
	Get-NPUsers -UserName 'temp*' | Remove-NPUser
#>
function Remove-NPUser {
	...
	process {
		if ($PSCmdlet.ShouldProcess("user $Id", 'Delete')) {
			Invoke-NPRequest -Method Delete -Path "users/$Id"
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA70VGNV2J2Jlt3
# 474WP33Ks3VKdnoVyg8a3rBZWxh6UaCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD/8YbV
# kN5BZomXClhnVEKFyK7wZ5JRbaVpQrIeOoDalDAKBggqhkjOPQQDAgRnMGUCMQD6
# Zr7DQDAJE3ow3DEPb1xfGfgxWcdWZFNOziK2qZPDOxqsCuDrP0UrYn2wOEH9FNcC
# MHr1NW2WV34vJQhDd2Vy6jfTQkIyeTSxnbfm9XkT2oNFqRh4S4dZPUQaC/QyBPfF
# P6GCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDYyMlowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMO98Ppg6
# qqqx5tWCQnWAwNEpR8Kw55YEdBggRUMdfU3i2pt0ETmOyC+7BwjKF9ZlCjCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYALcOq5VIj5
# OWhVCowCpsAIdUHVRtT9jWXePrDBTBQgnubJ8VbtGIdnLElBlP3J52uKdxIJyHZA
# MLwk/hI+x8/OW/nzktilB6BCdX4OOojdLxWh0oGt07NEgwDmIo697H9zjXdOe4HL
# hLdlatgjmLzdHUGU8BdV7DrCqBoeZNy4/Nob75CTGvber/VolpRZJCRFvhBuM6VJ
# KQc+2Z9/vhVYH4l0fuv2FyCJw+3y74laLyRfjIqu17i8gSkljSDqcqlMD8oKgiKo
# yMzUOqewwVyRh1CTDru50un5wSFxuY12AhNdvAEcuoCZVnwzVHB4AMgLGZG/Cwmd
# cP57gaPqyf33BUQlUYImbR03rYENR8aU1BSSOMq0iO5gitfbicoOnRLOl3664Nci
# Du4TQWmUvg8RpCzuJcdJdhOUtBLSsha2RpT/5m7W3otC9FFDiqrHKJpXYhSNEHq3
# PcnsH7fRTt9vlCkQLm6HCzUfNjgx8nXJR7Gazw6gee/YlUSmmDgZk2w=
