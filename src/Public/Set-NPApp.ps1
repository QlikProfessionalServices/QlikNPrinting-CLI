<#
.SYNOPSIS
	Updates an existing NPrinting app.
.DESCRIPTION
	PUT /apps/{id}. Get-NPApps, modify, then pass back to Set-NPApp.
.PARAMETER Id
	The id of the app to update.
.PARAMETER InputObject
	The full app body to store.
#>
function Set-NPApp {
	...
	process {
		if ($PSCmdlet.ShouldProcess("app $Id", 'Update')) {
			Invoke-NPRequest -Method Put -Path "apps/$Id" -Data $InputObject
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBA9MY/hYDnr58Q
# BS0qmbkaStjcbaPO2t7TbrNj0uOPuaCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCB5ZxjI
# f2MOHCoM6JTZ1hWKQOigsSt3s2NN+DID6o6DQjAKBggqhkjOPQQDAgRnMGUCMAyC
# wNDhxPAfHITeA08GvPjEiZa1FNUrJsSfvpA7RKFN7zxmlSI8GAgi08YxCSwcaAIx
# AMjplGax8qtlAVZbMZLjARry9JDtaeQnrR34bCDGTXuPfk8gAFpiUYE3YNGN4jve
# 8qGCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDYyM1owKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMEYTuN4k
# MndCH/+9nQguiSu0WyzMmyWEfDt786Y2Deo9GGb4kDv03izYf7tuRItJODCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYCHZmA0x7pO
# 9qZrUPFrMxdqjFeB6P+VGF/MS8+knh5zIi8iufK9ehUFLniTHz79hF0/1HBAZ6MH
# OTCeu1vEjUwQ0oIeu8dXwRhHio/h4GPr+fxDL9fntsbValvhVJhFkBtf9rFncbxp
# SE5VNMDTkuUuA/ts2w292tfaf4AczRuXh2N4k1g5SqQk13dtKiQLRWrbIoydPJo7
# XbHqFGct1nVc2vGMof4g3r3Gn3IMKIM+YLfwAjf7bh5V7n9OXuC2RI5BPka2s538
# A1t3kBDiHib19S8JEM9xTTcuHojjUgGtewzUckuyxHRd5NdUec+9drrTlQQDbizL
# UF7klEcH+avbrXEzWi3gKgZa2FXdpgscHHJRJhvHKEtt8fdB4wu/3OCRzfb++t71
# dAR8szg0w1NVCHHho9fig+e91CXe+fsmfSfancakRdA+hrHP90/HXtFiCIDf1ZG7
# e5J9dFRIn3JCVD8LXxHvJaMOlWdtTn9OgabcP7RJkdptQrbfjZqpH3E=
