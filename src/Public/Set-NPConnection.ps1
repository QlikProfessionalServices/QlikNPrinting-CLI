<#
.SYNOPSIS
	Updates an existing NPrinting connection.
.DESCRIPTION
	PUT /connections/{id}. Get-NPConnections, modify, then pass back.
.PARAMETER Id
	The id of the connection to update.
.PARAMETER InputObject
	The full connection body to store.
#>
function Set-NPConnection {
	...
	process {
		if ($PSCmdlet.ShouldProcess("connection $Id", 'Update')) {
			Invoke-NPRequest -Method Put -Path "connections/$Id" -Data $InputObject
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALuZ9x4mmzluQF
# 78yxgQn1i+9AxNKt/QNE1sTbDL4OVqCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBp2dN1
# 2x9IG3QFf6hJXswXbwry8jS6CzflEWCv35B62zAKBggqhkjOPQQDAgRnMGUCMDy3
# L0WQYFZ+A0Lcdf98qSHPccgvsXj/3P3bKPBtizT6ze40z+KZKZxpLNgY35u3AgIx
# AMYQ2CVNJSoMlibw1FDjeJv0dnEExloFcfeVbpbnm3D/of8JWrfQKKoCTirq6dtK
# EKGCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDYyNFowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMNoXbGtQ
# fA1TfutSDB9tEzoPKxVnP7djSt17T7k184DaNWgqkHRaao+d3ON/DudA/TCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYCFm24z5MSx
# 89ueVF4G+wtQ+lLkvNEcs1QlRllJAJ/n1fMq+zm4UVRB4UvcSt9unPEozwK4Qsy+
# bETumkSnnp064KzTVOhheYK+rlGXTi71SQHMXHePgN54ugdHNHd73ekUUXap82wi
# NSJ9wSevSv7MLX5twaRIhqYmBew+aXsmwziyCxKPBOraqgxcY+E7CQTLjhTLehPX
# Mq45lGBcI4QAVod3vkV5t1EG1XrgFaiU+I0Q/bpxUmQLhY/WXS5IZh9EVHAHrJNC
# yWxHylVqJN3XY11GxYectdiMjk0bxykIKWf0VMLH9p6vY/LbAR9bPiVfLUCEx0Ry
# XAvp9RDjtAgFsIb3dGzgTfZj9e4HMP4YcV3Z4wpgUnV5n5ccyX8yTVmgO1qkH1l2
# aPaR3uzYc3MqHpYdzg9oJGZ6vV780eUkFoQqyE268ef/YAFcRHKxBeSc9LsIhJra
# UUbd2KFjZVXUm4rX3i52JUuYZee8bmJsUX9Kmg2b9JVZQXk6Dt5qxUQ=
