<#
.SYNOPSIS
	Updates an existing NPrinting filter.
.DESCRIPTION
	PUT /filters/{id}. The natural flow is Get-NPFilters, modify the object, then
	pipe or pass it back to Set-NPFilter.
.PARAMETER Id
	The id of the filter to update.
.PARAMETER InputObject
	The full filter body to store.
.EXAMPLE
	$f = Invoke-NPRequest -Path "filters/$id"; $f.enabled = $false; Set-NPFilter -Id $id -InputObject $f
#>
function Set-NPFilter {
	...
	process {
		if ($PSCmdlet.ShouldProcess("filter $Id", 'Update')) {
			Invoke-NPRequest -Method Put -Path "filters/$Id" -Data $InputObject
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBppXnDMNQA4oGf
# y7Fdc/ltp2EtyrIeEGJw//zoZvOXXKCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCv8R6d
# Cwh0rJJaTbqRgPq8w0xXfwtsnvW2QzaZAQJcbTAKBggqhkjOPQQDAgRnMGUCMQDX
# DkV5ywaFaVTMe7NmSVh4rsYxb7Iszq8TxfJSRAiC/1TQQMYICactPgtuiHw+0W8C
# MCvN7zkU2Nz98W6amn4d9tLvGaYPlgOuITdCsLNqyoZ8UQ4sN4sql5poL3XU+s55
# GaGCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDYyNVowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMAWJdCYO
# BrNwyPaa7s2ImNmD8XA6pnOnLBEmQY/2n5F5ss0vqsU3RhbEGaiVlYNJ5jCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYBWkOsS9Jcp
# ONJzhc+QEiiNWRPLr/G3xYb1aILnsbKFGrvNPcXoC7x51TR3W/ebiIdvXnMt/QqM
# wBqI9fqt0EF/YI96L93L5hykSD3yfo3kvCEoMDhwcmtg6BCXcsW9uHpEHl9dFhRC
# yXMhoBcZXNIef/XzlLaofyg+4h0TRwrwWgNWuIwatX9LPJRJhS/g2HpMe/n15BiH
# aLLVvTUWPdihdkfpASBYDSRmfi3yiO5ZU3EVU7esKpXv5YKBgAhY+K2XWD/gImRa
# 6oNmJCAimjYHt95wFgBWkUijF0/WxawGoUJ3xF9VsHpYupdmpBzlXYjMcYJN52wz
# HSp2WLDE2NFvo335ei+Xpk2XkZJKJTx66CeTOwKL197JkbUlr0bSU3HG9lqGIB4i
# OGQKuP0WKcOZAv37rblysuwxcmyKFGfAwjUAkH41DaEjcNYNTWY77ZiHMFvD5FaO
# zQ5v7mKEs8so8Tc9yOYPejk/Kog+LTUztvNzBtoe/jtFX78bis2ZKPI=
