<#
.SYNOPSIS
	Updates an existing NPrinting group.
.DESCRIPTION
	PUT /groups/{id}. Get-NPGroups, modify, then pass back to Set-NPGroup.
.PARAMETER Id
	The id of the group to update.
.PARAMETER InputObject
	The full group body to store.
#>
function Set-NPGroup {
	...
	process {
		if ($PSCmdlet.ShouldProcess("group $Id", 'Update')) {
			Invoke-NPRequest -Method Put -Path "groups/$Id" -Data $InputObject
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBy6vCeiQo+MNlA
# Jpr1Kwd5UAENpDNUKGUuJahreavrPaCCGb0wggN5MIIC/qADAgECAhAcz51nzeIZ
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCm0VYk
# Czz9/+sbOCTKPl1HKlsUmtgyPz+51piJgfDRUjAKBggqhkjOPQQDAgRnMGUCMQCp
# SSG/QWVjHhFtRZjDdAolw11oNpKEMaAyxoaK7uqkbTd3k5v+hCajaQtei4Xz6AcC
# MGD6wUiR3Tt0PjXnz/MQjpaUV2qhNayNBNnNKFPS8tEAfHMSDTk2QXZ8Voin6gCD
# CKGCA4QwggOABgkqhkiG9w0BCQYxggNxMIIDbQIBATBzMF4xCzAJBgNVBAYTAkJF
...
# HAYJKoZIhvcNAQkFMQ8XDTI2MDcwMTE0NDYyNlowKwYJKoZIhvcNAQk0MR4wHDAL
# BglghkgBZQMEAgKhDQYJKoZIhvcNAQEMBQAwPwYJKoZIhvcNAQkEMTIEMPeVPyLB
# daqLxYg4sgNtUPqmaRQnfQPNSttLBnCJw/Hj1y9ajqI5zVd3EmhlIksGXDCBqAYL
...
# MDI1AhEAhHI/uDAN+6h1sztXzCY3gjANBgkqhkiG9w0BAQwFAASCAYAdev4Qy07U
# GJ4uGvXSltoovfV44eYRqeaVjHCFk9DokCr7hS4vIElJVSpZpYEOwPqkEsysPAsW
# 2vykqzpJUhvEAIsMAbSB/pt82yy6uLQQTKyfQ3NcMuRWhAJarSl3F0Uj3/p+q+de
# vnuFH5HsM2Pepa4PhfXt6TrnR5FcP7jZ1UeKShTzeCXDkNjCDXrA4DwoHc/mx1z5
# qYlXDPxStXdRwAz+R+Y/iIiMqtJAXr0Sp38Vds+g8xkTzzwBofdc7nukkmbcCkSt
# wWJINIG1g3vUDk8E/4DLIdhZ83LvTzK5CXXuXXjQVASVnvNwNCy4jwNmYZoeYPAR
# PGErlphls+sQn96C587XhuUlJ0pzcAlBNnT0fOFK3E1qP+Xa6NldKIre0CRLCcO0
# fVvAoVOw3a7Sv3euFESRhUvQERUpASeZ5SEZNBM6yxLrew/sH7HNuokZISOXT30W
# vQ3bgS98LHy2GKghcmpUohOR7V5Kgx0Jc2Nh/iacQd8V44nFZtzkBeI=
